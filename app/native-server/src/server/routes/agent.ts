...
export function registerAgentRoutes(fastify: FastifyInstance, options: AgentRoutesOptions): void {
    ...
    fastify.post('/agent/projects', async (request: FastifyRequest<{ Body: CreateOrUpdateProjectInput }>, reply: FastifyReply) => {
    ...
    fastify.delete('/agent/projects/:id', async (request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) => {
    ...
    // Path validation API
    fastify.post('/agent/projects/validate-path', async (request: FastifyRequest<{ Body: { rootPath: string } }>, reply: FastifyReply) => {
    ...
    fastify.post('/agent/projects/create-directory', async (request: FastifyRequest<{ Body: { absolutePath: string } }>, reply: FastifyReply) => {
    ...
    fastify.post('/agent/projects/default-root', async (request: FastifyRequest<{ Body: { projectName: string } }>, reply: FastifyReply) => {
    ...
    fastify.get('/agent/projects/:projectId/sessions', async (request: FastifyRequest<{ Params: { projectId: string } }>, reply: FastifyReply) => {
    ...
    fastify.post('/agent/projects/:projectId/sessions', async (
    ...
    fastify.get('/agent/sessions/:sessionId', async (request: FastifyRequest<{ Params: { sessionId: string } }>, reply: FastifyReply) => {
    ...
    // Update a session
    fastify.patch('/agent/sessions/:sessionId', async (
        request: FastifyRequest<{
    ...
    // Delete a session
    fastify.delete('/agent/sessions/:sessionId', async (request: FastifyRequest<{ Params: { sessionId: string } }>, reply: FastifyReply) => {
    ...
    fastify.get('/agent/sessions/:sessionId/history', async (
        request: FastifyRequest<{
            Params: { sessionId: string };
    ...
    fastify.delete('/agent/chat/:sessionId/cancel/:requestId', async (
    ...
    fastify.delete('/agent/chat/:sessionId/cancel', async (request: FastifyRequest<{ Params: { sessionId: string } }>, reply: FastifyReply) => {
     ...
     */
    fastify.get('/agent/attachments/:projectId/:filename', async (
     ...
     */
    fastify.delete('/agent/attachments/:projectId', async (request: FastifyRequest<{ Params: { projectId: string } }>, reply: FastifyReply) => {
     ...
     */
    fastify.delete('/agent/attachments', async (request: FastifyRequest<{ Body?: AttachmentCleanupRequest }>, reply: FastifyReply) => {
